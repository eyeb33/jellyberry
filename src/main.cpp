...
void loop() {
 ...
 DEBUG_PRINTLN("Lamp mode stopped");
 ...
 DEBUG_PRINTLN("Button 1 disabled in VU mode - use button 2 to advance");
...
void updateLEDs() {
 ...
 pomodoroState.startTime = millis();
 pomodoroState.paused = false;
 Serial.println("Pomodoro timer auto-started");
